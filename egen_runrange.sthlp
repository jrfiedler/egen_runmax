...
{phang}
{bf : egen runrange} {hline 2} generate running range of a numeric variable{p_end}
...
{synopthdr}
{synoptline}
{synopt:{opth by(varlist)}}group by specified variables when finding range; 
	{cmd:runrange} will calculate the running range separately in each 
	group implied by {it:varlist}{p_end}
	
{synopt:{opth sort(varlist)}}sort on specified variables before calculating
	the running range; the original sort order will be restored afterwards{p_end}
{synoptline}
{p2colreset}{...}
...
{title:Examples}
      ...
      {com}. egen rangex_y = runrange(x) , by(y)
      {res}{txt}(3 missing values generated)
      
      {com}. list
      {txt}
           {c TLC}{hline 4}{c -}{hline 3}{c -}{hline 8}{c -}{hline 10}{c TRC}
           {c |} {res} x   y   rangex   rangex_y {txt}{c |}
           {c LT}{hline 4}{c -}{hline 3}{c -}{hline 8}{c -}{hline 10}{c RT}
        1. {c |} {res}-2   .        0          . {txt}{c |}
        2. {c |} {res} .   .        .          . {txt}{c |}
       ...
       10. {c |} {res} 3   1       12          7 {txt}{c |}
           {c BLC}{hline 4}{c -}{hline 3}{c -}{hline 8}{c -}{hline 10}{c BRC}
      
      {com}. list x y rangex_y if y == 0
      {txt}
           {c TLC}{hline 4}{c -}{hline 3}{c -}{hline 10}{c TRC}
           {c |} {res} x   y   rangex_y {txt}{c |}
           {c LT}{hline 4}{c -}{hline 3}{c -}{hline 10}{c RT}
        3. {c |} {res} 4   0          0 {txt}{c |}
        5. {c |} {res}-1   0          5 {txt}{c |}
        7. {c |} {res} 7   0          8 {txt}{c |}
        9. {c |} {res}-5   0         12 {txt}{c |}
           {c BLC}{hline 4}{c -}{hline 3}{c -}{hline 10}{c BRC}
      
      {com}. list x y rangex_y if y == 1
      {txt}
           {c TLC}{hline 4}{c -}{hline 3}{c -}{hline 10}{c TRC}
           {c |} {res} x   y   rangex_y {txt}{c |}
           {c LT}{hline 4}{c -}{hline 3}{c -}{hline 10}{c RT}
...
{help egen_runmin:egen_runmax}, {help egen_runrange:egen_runmin}
